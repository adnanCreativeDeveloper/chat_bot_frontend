...
function SidebarBody({ setChatArray }) {
  ...
  return (
    <>
      <div className='scrollbar-custom h-5/6 overflow-x-hidden overflow-y-auto'>
        <ul className='min-h-14 list-none'>
          <li
        ...
        hover:bg-neutral-800 '>
            ...
            border-neutral-600 flex items-center justify-center'>
              ...
              <div>
                <p className='text-gray-200 text-sm'>ChatBot</p>
              </div>
            </div>
            <div className='hidden group-hover:block py-2.5 px-1.5 rounded-r-lg absolute right-0 top-0'>
              <svg
