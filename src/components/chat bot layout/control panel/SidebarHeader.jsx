...
function SidebarHeader() {
  return (
    <>
      <div className=''>
        <div className='sticky w-full h-14 flex items-center justify-between'>
          <span
            data-tooltip-id='close-sidebar'
            className='p-2 rounded-lg cursor-pointer hover:bg-neutral-800'>
            <svg
